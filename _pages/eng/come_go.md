...
- go to
  ...
  - Let's go to a museum now.(用a代表任意一家，不指定)
- come to
...
- Fly to + 目的地
  ...
  - They are flying to London next week.（他們下週要飛去倫敦。）
- Move to + 目的地
...
- Climb to + 目的地
  - Climb carefully to the cave.
（小心地爬到洞穴。）
  - We climbed to the top of the mountain.（我們爬到了山頂。）
- Head to + 目的地 前往
...
## 移動動詞 + 方向副詞 + to + 目的地
* **前面的動詞（go, walk, head, run, take...）：** 決定你用什麼方式移動。
* **中間的副詞（up, down, back, over, in, out）：** 決定方向感（往上、往下、回去、過去、進去、出去）。
* **後面的 to + 目的地：** 標明終點站，以上能把「動作的方向」跟「最後要去哪裡」交代得清清楚楚。
...
移動動詞 + past(介系詞) + 地點
```
* Past 在這裡是一個「介系詞」(Preposition)，用來告訴別人你「走」的動作是「經過」。
...
然后左转。
* *I **walked past** the coffee shop.*（我**路過**那間咖啡廳。 $\rightarrow$ 只是走過去，人已經往前走了，沒有進去）
* *Don't **walk past** the exit.*（不要**走過/錯過**那個出口。）
...
（時間不早了，我想我該回家了。）
- come home（回來家裡）說話的人此時「人已經在家裡」，對方還在外面
...
- Walk down the street. 沿著街「往前」走
- Drive down the street. 沿著街「往前」開
- Drive down this road.（順著這條路往前開）
...
- Walk straight to the reception desk.直走去接待櫃台。
- Walk straight to the convenience store.直走去便利商店。
- Drive straight to the parking lot.直開車去停車場
- Drive straight to the airport.

## straight + past + 目標物 (直走並經過目標物)
