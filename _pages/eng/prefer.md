...
（我**寧願**待在家裡，**也不要**去派對。）
7. She prefers **to cook** her own meals **rather than** buy takeout.
（她**寧願**自己煮飯，**也不要**買外賣。）
8. He prefers **to face** the problem head-on **rather than** hide from it.
（他**寧願**正面迎戰問題，**也不要**逃避它。）
9. We prefer **to book** tickets in advance **rather than** risk missing out.
（我們**寧願**預先訂票，**也不要**冒著錯過的風險。）
...
（他禮拜五比較喜歡穿休閒服。）
15. We prefer **to settle** this matter privately.
（我們比較傾向私下解決這件事。）