---
title: buy, get, pay, spend, take, cost
date: 2026-07-28
...
## spend vs. cost
* 用 Cost? → How much does **your car** cost?（你的車賣多少錢？ → 問車的標價）
* 用 Spend? → How much do **you** spend on your car?（你在車上花了多少錢？ → 問改裝、保養、加油的總開銷）


|動詞|主詞是誰？|核心邏輯|
|:-------|:---------|:-------------|
|Cost|物品 / 餐點|這東西「標價」是多少。|
|Spend|人|我「決定」花多少資源（錢/時間）進去。|
|Take|事情|這件事「耗掉」多少時間。|
|Buy|人|我「支付」金錢獲得物品。|
...
----------------------------------
這句話用 **`use`**（使用）其實是一個非常聰明且巧妙的問法！

如果用直譯來想，你可能會覺得怪怪的：「我們又不是把錢拿來當玩具或工具，為什麼是用『使用』，而不是『花費（spend）』或『擁有（have）』呢？」

我們來拆解為什麼這裡一定要用 **`use`**，以及它背後的語感：

---

### 1. 為什麼不用 spend 或 have？

* **如果用 `spend`（花費）：**
* *Do you spend euros or dollars?*
* 這樣變成在問對方「你都花掉歐元還是美元？」**，語意會變成在問消費習慣，而不是在問「你們國家／這個地方**流通的是哪種貨幣」。


* **如果用 `have`（擁有）：**
* *Do you have euros or dollars?*
* 這樣變成在問「你身上（皮夾裡）現在有歐元還是美元？」，對象變成個人口袋裡的現金。
...
在英文中，當你想問一個國家、一個地方、甚至是一間商店「流通、接受、或普遍使用哪一種貨幣或支付方式」**時，**`use` 是最完美的動詞。

因為它代表「在日常生活中運作、交易時所採用的媒介」。

* **常見的實用情境：**
* 當你出國旅遊，到了某個國家（例如去歐洲或中美洲），你想確認當地是用什麼錢幣買東西，你就可以直接問當地人或店員：
* **`Do you use euros or dollars here?`**（你們這裡是用歐元還是美元？）
* **`Do you use cash or credit cards?`**（你們這裡是用現金還是信用卡？）
...
2. **What currency do you use?**（你們使用什麼貨幣？）
* 這句更直接，*currency* 就是「貨幣」的意思。



所以，用 **`use`** 來問貨幣，是在問「交易時所使用的工具與流通貨幣」，非常道地且自然喔！