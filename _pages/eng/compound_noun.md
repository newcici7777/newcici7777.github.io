...
title: 複合名詞
date: 2026-09-26
keywords: english, compound noun
---
## 多個名詞組合
> 當一個名詞用來形容另一個名詞時，通常會直接把名詞放在名詞前面。<br>
> 名詞 + 名詞
...
> 當名詞前面加上另一個名詞（當作形容詞用，如 office use）或純形容詞（如 professional use）時，它們的作用是「限定這個**使用的**對象、範圍或性質」：
...
- beginner level history class(核心名詞) 
- high school computer science teacher(核心名詞) 

------------------------
## 食物複合名詞是不可數名詞
> 只要是兩個單字合起來的**食物名詞**，在英文裡幾乎都是**不可數名詞**
...
-------------------------------------
## -house 複合名詞(可數名詞加S)
結尾-house：在這裡指「專門營業的店面、餐館」，引申為「容納某種活動或特定人群的建築物/機構」

### 1. 餐廳與餐飲場所

* **Steakhouse**：牛排館(專門賣牛排的餐廳)
  - Let's go to **a** steakhouse for dinner.我們晚餐去吃牛排館吧。
* **Pancake house**：煎餅屋 / 鬆餅店（專賣鬆餅、美式早餐的餐廳）
* **Public house (Pub)**：酒館、酒吧（*pub* 這個字其實就是從 *public house* 縮寫來的）
* **Waffle house**：鬆餅屋（美國知名的連鎖鬆餅餐廳）

### 2. 娛樂與表演場所

* **Opera house**：歌劇院（例如著名的雪梨歌劇院 Sydney Opera House）
* **Playhouse**：戲院、兒童遊戲屋
* **Coffeehouse**：咖啡館（通常指氣氛較文藝、提供座位讓人久坐聊天的咖啡廳）

### 3. 政府、教育與公共機構

* **White House**：白宮（美國總統官邸）
* **Statehouse**：州議會大廈（美國各州的議會大樓）
* **Schoolhouse**：校舍、村里學校
