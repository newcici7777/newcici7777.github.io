...
- We learned a lot from the experience.（我們從這次經驗中學到了很多。）
...
## 4. learn from Ving 從……中學習/學到
如果想表達「從……中學習/學到」，learn 後面會接介系詞 from，而 from 是介系詞，因此它後面的動詞必須用 V-ing。
```
learn + from + V-ing 
```
- We learn a lot from making mistakes.（我們從犯錯中學到很多。）
- She learned a lot from working there.（她從在那裡工作學到了很多。）
- I learned a lot from swimming.


💡 核心總結
- learn + to + 動詞：學習去做某事（例如：learn to cook）
- learn + 名詞：學習/得知某個東西（例如：learn Chinese）
