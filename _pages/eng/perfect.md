...
## 現在完成式 + 否定句 for vs in
現在完成式 + 否定句 = 在……這段期間之內（一直沒做）

```
現在完成式 + 否定句 + in + 一段時間 = 在這段期間「之內」，「一直」都「沒有」
```
...
否定句（haven't, didn't）時，in + 一段時間，語感會變成：「在過去這段期間之內（竟然連一次都沒有發生）」。
...
用 It，是為了「避免重複並精簡」：一旦雙方都已經知道在談論「這件事」了，英文的習慣是不斷用 it 來代替前面出現過的名詞或概念。
