...
- I have the wrong number.（我打錯電話了／我拿錯號碼了 → 我目前握有的號碼是錯的）
- You have the wrong person.（你找錯人了）

- They got the wrong bags.強調的是「過程」（他們剛剛去領行李時，不小心拿到錯的了）。
- They took the wrong bags.強調的是「動作」（他們把錯的行李拿走了）

## have 形容一個地方「具備、擁有某種特色、風景或氣候條件」
- This hotel has great views.（這間飯店擁有絕佳的視野。）
