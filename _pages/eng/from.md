...
指從一點「離開」到另一點。
* My home is far from the office.(我家離辦公室很遠。)
* We are from Taiwan.(我們來自台灣。)

## 時間的開端 (Starting time)
指某件事「從何時開始」。
* The shop is open from 9 a.m. to 6 p.m.(商店從早上九點開始營業。)
...
* 時間從幾點到幾點：Work from 9 AM to 5 PM.（從早上九點工作到下午五點）
...
不只是走路，只要是講「移動、時間、距離」，這個組合都無所不在：

- walk + from [起點] + to [目的地]
  - Walk from the station to the bookstore. （從車站走路走到書店。）
...
🚌 3. 搭公車（Take a bus）
* They took a bus from the station to the museum. （他們從車站搭公車到博物館。）

🚇 4. 搭地鐵／捷運（Take the subway / MRT）
* He took the subway from home to the office. （他從家裡搭地鐵到辦公室。）

🚲 5. 騎腳踏車（Ride a bike / Cycle）
* We rode our bikes from the park to the beach. （我們從公園騎腳踏車到海灘。）

✈️ 6. 搭飛機（Fly）
* We flew from New York to London last week. （我們上週從紐約搭飛機到倫敦。）
